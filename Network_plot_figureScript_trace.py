...
class NetworkPlotTraces():
  ...
  def plotTraces(self,traceID=None,offset=150e-3,colours=None,skipTime=None,
    ...
    plt.fill_between([-0.01,2.3+0.01-skipTime], [-0.06,-0.06], [-0.08,-0.08], color='lightgrey')
    #plt.fill_between([0.5,1.0], [0.02,0.02], [-0.08,-0.08], color='lightgrey')
    #plt.fill_between([1.2,1.5], [0.02,0.02], [-0.08,-0.08], color='lightgrey')
    
    plt.xlim(  [-0.01,2.3+0.01-skipTime])
    plt.axis('off')
