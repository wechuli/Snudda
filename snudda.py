...
class Snudda(object):
  ...
  def simulate(self,args):
    ...
    nWorkers = 12
    cmdStr = "nrnivmodl cellspecs/mechanisms_with_modulation && mpiexec -n " + str(nWorkers) + " -map-by socket:OVERSUBSCRIBE python3 snudda_simulate.py " + networkFile + " " + inputFile + " --time " + str(args.time) + " --disableGJ"
