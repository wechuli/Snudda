  ...
  def addNeurons(self,name,
    ...
    for d in dirList:
      ...
      if(os.path.isdir(d)):
        ...
        neuronFileList.append((d,swcFile[0],parFile,mechFile,protFile,hocFile[0]))
    ...
    for ctr, ((nrnDir,swcFile,parFile,mechFile,protFile,hocFile),num) \
